		...
		<div class="container">
		  ...
		  <div class="navbar-collapse collapse">
			<ul class="nav navbar-nav pull-right">
			  ...
			  <li class="active"><a href="barangay.php">Barangay Lists</a></li>
    ...
    <div class="container serviceslist">
      ...
      <div class="col-md-12">
        ...
        <header class="page-header">
					<h1 class="page-title">Barangay Lists</h1>
				</header> 
                </div>
		 </div>
		 ...
		 <table  style="border: black solid; border-collapse: collapse; width: 80%;">
			...
			<th style="width: 124px;">Postal code</th>
			<th style="width: 154px;">Population<br>01-May-00</th>
			<th>Population<br>2012</th>
			<th>Population<br>growth rate
			</th></tr>
		   </thead><tbody style="padding-left: 20px;">
			<tr>
			<td >1</td>
			<td>Ciudad Real</td>
			<td>1st</td>
