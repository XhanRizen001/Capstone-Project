...
<body>
	...
	<div class="container"> 
        ...
        <header class="page-header">
                ...
                <h4>
                    You can view crimes by classification of Crimes:
                </h4>
                <p>
                    <b>Infraction <i>(Least Serious)</i></b> : Also known as petty crimes, infractions consist of minor criminal offenses.
                </p>
                <p>
                    <b>Misdemeanor <i>(Serious)</i></b> : Misdemeanor charges are the median between infractions and felonies. The difference between a misdemeanor and a felony charge is the crime's level of severity.
                </p>
                <p>
                    <b>Felony <i>(Most Serious)</i></b> : Felonies are the highest level of criminal offenses involving the most severe penalties. Felony charges affect every member associated with committing the crime including the offender and their accomplices.
                </p>
            ...
            <div class="row">
                <nav id="filter" class="col-md-12 text-center">
                    <ul>
                        ...
                        <li><a href="#" class="btn-theme btn-small" data-filter=".LeastSerious">Infraction</a></li>
                        <li><a href="#" class="btn-theme btn-small" data-filter=".Serious">Misdemeanor</a></li>
                        <li><a href="#" class="btn-theme btn-small" data-filter=".MostSerious">Felony</a></li>
